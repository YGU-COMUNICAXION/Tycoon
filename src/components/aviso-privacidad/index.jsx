...
const AvisoPrivacidad = () => {
  return (
    <section className="avisoPrivacidad">
      ...
      <p>
        Le informamos que sus datos personales no son compartidos con terceros,
      ...
      <ul>
        ...
        <ul>
          <li>
            ...
            directa o a través de la página web www.tycoon.mx
          </li>
          <li>
      ...
      <p>
        ...
        para usos distintos a los señalados en este apartado. Si usted no desea
        que sus datos personales sean tratados para las finalidades secundarias
        señaladas, puede negarnos su consentimiento desde este momento marcando
        en la siguiente tabla aquellas opciones para las que no desea que sus
        datos personales sean utilizados.
      </p>
      ...
      <p>
        Su negativa para estas finalidades no será motivo para dejar de prestar
        el servicio o información solicitada.
      </p>
      ...
      <p>
        ...
        terceros nacionales o internacionales. Entendiéndose por "transferencia"
        cualquier comunicación de datos personales dentro o fuera del territorio
        nacional, realizada a persona distinta del titular, del responsable o
        del encargado.
      </p>
      ...
      <p>
        ...
        personales en cualquier momento, así como a oponerse al tratamiento de
        los mismos. Para ejercer cualquiera de estos derechos, favor de
        contactar a Luz Adriana Azuela en nuestro departamento Legal vía
        telefónica al <a href="tel:5553957833">5553957833</a> extensión 288, o
      ...
      <ol>
        <li>
          ...
          telefónico u otro medio para comunicarle la respuesta a su solicitud.
        </li>
        <li>
          Los documentos que acrediten la identidad o, en su caso, la
          representación legal del titular (credencial del INE o documento de
          identidad nacional aplicable, pasaporte, poder notarial).
        </li>
        <li>
        ...
        <li>
          Cualquier otro elemento o documento que facilite la identificación y
          localización de los datos personales.
        </li>
      </ol>

      <p>
        El responsable comunicará al titular a través del medio designado en la
        solicitud, en un plazo máximo de veinte días, contados desde la fecha en
        que se recibió la solicitud de acceso, rectificación, cancelación u
        oposición, la determinación adoptada, a efecto de que, si resulta
        procedente, se haga efectiva la misma dentro de los quince días
        siguientes a la fecha en que se comunica la respuesta.
      </p>

      <p>
        La información o datos personales solicitados serán otorgados para su
        acceso por medio de documentos electrónicos, copia simple o cualquier
        otra modalidad que resulte aplicable al caso.
      </p>
      ...
      <p>
        ...
        efectos retroactivos. Sin embargo, es importante que tenga en cuenta que
      ...
      <p>
        Para revocar su consentimiento podrá hacer la solicitud correspondiente
        por medio de nuestra página web{" "}
        <a href="https://www.tycoon.mx">www.tycoon.mx</a> en la parte inferior
        dentro de la sección “Privacidad” y dando click en la opción “Revocación
        del consentimiento”, o contactando a Luz Adriana Azuela en nuestro
        departamento Legal vía telefónica al{" "}
      ...
      <p>
        La solicitud deberá de incluir la siguiente información y documentos:
      </p>
      <ol>
        <li>
        ...
        <li>
          La descripción clara y precisa de los datos personales respecto de los
          que se busca ejercer el derecho antes mencionado, y
        </li>
        <li>
      ...
      <p>
        El responsable comunicará al titular a través del medio designado en la
        solicitud, en un plazo máximo de veinte días, contados desde la fecha en
        que se recibió la solicitud de revocación de consentimiento, la
        determinación adoptada, a efecto de que, si resulta procedente, se haga
        efectiva la misma dentro de los quince días siguientes a la fecha en que
        se comunica la respuesta.
      </p>

      <h2>Uso de cookies (aplica únicamente para usuarios de la página web)</h2>
      <p>
        Le informamos que en nuestra página de Internet utilizamos cookies y web
        beacons a través de las cuales es posible monitorear su comportamiento
        como usuario de Internet para obtener su dirección IP, horario de
        navegación, tiempo de navegación en nuestra página de Internet,
        secciones consultadas, y páginas de Internet accedidas previo a la
        nuestra, así como brindarle un mejor servicio y experiencia de usuario
        al navegar en nuestra página.
      </p>
      ...
      <p>
        ...
        servidor de Internet algunos datos sobre este usuario, respecto a sus
        preferencias para la visualización de las páginas en ese servidor (i.e.
        tipo de navegador utilizado, páginas visitadas).
      </p>

      <p>
        Los web beacons son una imagen visible u oculta insertada dentro de un
        sitio web o correo electrónico, que se utiliza para monitorear el
        comportamiento del usuario en estos medios. A través de éstos se puede
        obtener la siguiente información: la dirección IP de origen, navegador
        utilizado, sistema operativo, momento en que se accedió a la página, y
        en el caso del correo electrónico, la asociación de los datos anteriores
        con el destinatario.
      </p>
      ...
      <p>
        Tanto las cookies como los web beacons pueden ser deshabilitados por el
        usuario si así lo desea. Para conocer cómo hacerlo, consulte el
        siguiente enlace:{" "}
      ...
      <p>
        ...
        <a href="https://www.tycoon.mx">www.tycoon.mx</a> o vía telefónica al
        momento de comunicarse con nosotros al{" "}
