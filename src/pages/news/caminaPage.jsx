    ...
    <Layout>
      {windowSize < 752 ? (
        <>
          ...
          >
            <img alt="" src={Camina1} className="amongfFirstimg" />
            <img alt="" src={Camina2} className="amongfFirstimg" />
            <div className="finalPDivMob">
              <a
                href="https://www.lolyinthesky.com.mx/"
                target="_blank"
                rel="noreferrer"
              >
                <h2 className="finalP">
                  {renderStringHMTLtoJSX(t("caminaFinalP"))}
                </h2>
              </a>
            </div>
          </SingleNews>
            ...
            <div className="newsDualDiv">
              <div className="dualLeftDiv">
                <p className="regularP">
                  {renderStringHMTLtoJSX(t("caminaFirstP"))}
                </p>
              </div>
