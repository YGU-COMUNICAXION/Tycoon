...
import enBackgroundDesk from "../images/desktop/contacto/PORTADA-CONTACT-eng.webp";
    ...
    <Layout>
      {windowSize < 752 ? (
        <div className="MainDiv">
          ...
          <div className="contactSecondSection">
            ...
            <div className="contactFormDiv">
              <form action="https://formspree.io/f/xeqwjolb" method="POST">
                <input
                  type="text"
                  name="Nombre"
          ...
          <div className="contactThirdSection">
            <h2 className="sectionTitle" id="contArg">
              {renderStringHMTLtoJSX(t("whereTitle"))}
            </h2>
            <div id="contBz">
        ...
        <div className="MainDivDesk">
          <div
            className="contactFirstSectionDesk"
                ...
                <div className="inputsDeskDiv">
                  <div className="formLeftDeskDiv">
                    ...
                    <select type="text" name="Territorio de interés">
                      ...
                      <option value="item1" className="opcion">
                        {t("argentina")}
                      </option>
                      <option value="item2" className="opcion">
                        {t("brazil")}
                      </option>
                      <option value="item3" className="opcion">
                        {t("centroam")}
                      </option>
                      <option value="item4" className="opcion">
                        {t("chile")}
                      </option>
                      <option value="item5" className="opcion">
                        {t("colombia")}
                      </option>
                      <option value="item6" className="opcion">
                        {t("ecuador")}
                      </option>
                      <option value="item7" className="opcion">
                        {t("mexico")}
                      </option>
                      <option value="item8" className="opcion">
                        {t("peru")}
                      </option>
                    </select>
                  </div>
